...
type PossClassArrType = { id: number; title: string };

// SignUp 페이지
export default function Signup() {
  const [possClassArr, setPossClassArr] = useState<PossClassArrType[]>([]); // 수업 DB 정보
  ...
  const [file, setFile] = useState<File | null>(null); // 강사 자료
