...
const HeaderSection = styled.section`
  ...
  background: linear-gradient(
    ...
    url('/src/Program_IMG/Pila/Program_Header_Pila_Background_IMG.png');
  ...
  @media (max-width: 768px) {
    background: url('/src/Program_IMG/Pila/Program_Header_Pila_Background_IMG.png');
    width: 90vw;
    min-height: 327px;
    padding: 0 2rem;
...
const ClassDetailSection = styled.section`
  ...
  background-image: url('/src/Program_IMG/Pila/Program_ClassDetailSection_Background_IMG.png');
