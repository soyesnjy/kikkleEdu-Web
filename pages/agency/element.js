...
const ElementPage = () => {
  ...
  return (
    <MainContainer>
      ...
      {/* 미들 섹션 - 수업 영상 */}
      <AgencyMiddleSecondSection agency={`초등학교`} youtubeUrl={youtubeUrl} />

      {/* 미들 섹션 - 수업 프로그램 */}
      <MiddleSectionThird>
        <MiddleSectionSubtitle>Our Program Image</MiddleSectionSubtitle>
        <MiddleSectionTitle>초등학교 프로그램</MiddleSectionTitle>
        <Description>
          {mobileFlag
            ? `아이들이 재미있게 체험할 수 있는 \n 다양한 소예키즈의 교육프로그램`
...
const HeaderSection = styled.section`
  ...
  background-image: url('/src/Agency_IMG/초등학교/Agency_element_Header_Background_IMG.png');
